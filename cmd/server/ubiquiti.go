...
import (
	...
	"github.com/a23667788/internal/client/postgres"
...
func (ui *Ubiquiti) initializeRoutes() {
	...
	ui.Router.HandleFunc("/hello", ui.helloHandler)
}

func (ui *Ubiquiti) helloHandler(w http.ResponseWriter, r *http.Request) {
	fmt.Println("hello")
}
